...
try:
	...
	print W + ' '
	print ('S H A H R I A R').center(44)
	print ' '
...
def baliho():
	try:
		...
		print ' ' + W
		print ('S H A H R I A R').center(44)
		print (W + '     [' + G +'Open Source Information Facebook, Powered By Shahriar Al Amin Bijoy'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     ShahRiar '81J0Y'
    Name       ShahRiar 'Open Source Information Facebook'
    CodeName   81J0Y
    version    full version
    Date       16/05/2018 09:35:12
    Team       Shurma Boys'
    Email      shahriaralaminbijoy@gmail.com
    Telegram   @81J0Y
